...
return E("div",{style:{maxWidth:640,margin:"0 auto",paddingBottom:30}},
 ...
 E("div",{style:card},sec("Weitermelden per WhatsApp","Geht an den Besteller sowie an Roberto und Erol. Pro Empf\xE4nger einen Knopf antippen."),
  E("div",{style:{display:"flex",gap:8,flexWrap:"wrap"}},
   Xg(e.besteller).map(i=>E("a",{key:i,href:zg(i,t),target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",background:"#25D366",color:"#fff",borderRadius:999,fontWeight:800,padding:"11px 16px",fontSize:14}},"WhatsApp an "+i)),
   E("a",{href:n,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",color:H.navy,fontSize:13,fontWeight:700,alignSelf:"center",marginLeft:4}},"anderen Chat w\xE4hlen"),
